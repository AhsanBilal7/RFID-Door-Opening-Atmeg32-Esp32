...
#define flag_on D8
#define flag_of D0
#define SS_PIN D2  //--> SDA / SS is connected to pinout D2cc
...
void setup() {
  ...
  Serial.println("");
  pinMode(flag_on , OUTPUT);
  pinMode(flag_of , OUTPUT);
...
void loop() {
  ...
  /////////////Magic or authorization//////////////////////////
  if(StrUID == "79CBE9BA")
  {
    digitalWrite(flag_on, HIGH);
      digitalWrite(flag_of, LOW);
  Serial.println(" Authorized");
  }
 else if(StrUID == "C955104D")  {
    digitalWrite(flag_of, HIGH);
     digitalWrite(flag_on, LOW);
    ...
    else
  {
    digitalWrite(flag_on, LOW);
      digitalWrite(flag_of, LOW);
  Serial.println(" Not At All Authorized");}
  /////////////Magic or authorization//////////////////////////
//  Serial.print(StrUID);
  ///////////////////////////////////////////////////////////////////////////////
}
